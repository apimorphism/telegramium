...
trait Methods {
  ...
  implicit private def decodeEither[A, B](implicit
    decoderA: Decoder[A],
    decoderB: Decoder[B]
  ...
  def setChatPhoto(chatId: ChatId, photo: IFile): Method[Boolean] = {
    ...
    MethodReq[Boolean]("setChatPhoto",
                       req.asJson,
                       Map("photo" -> Option(photo)).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
   ...
   */
  def getGameHighScores(userId: Int,
  ...
  def createNewStickerSet(userId: Int,
    ...
    MethodReq[Boolean]("createNewStickerSet",
                       req.asJson,
                       Map("png_sticker" -> pngSticker, "tgs_sticker" -> tgsSticker).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendVideoNote(chatId: ChatId,
    ...
    MethodReq[Message]("sendVideoNote",
                       req.asJson,
                       Map("video_note" -> Option(videoNote), "thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendDocument(chatId: ChatId,
    ...
    MethodReq[Message]("sendDocument",
                       req.asJson,
                       Map("document" -> Option(document), "thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendAudio(chatId: ChatId,
    ...
    MethodReq[Message]("sendAudio",
                       req.asJson,
                       Map("audio" -> Option(audio), "thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendVoice(chatId: ChatId,
    ...
    MethodReq[Message]("sendVoice",
                       req.asJson,
                       Map("voice" -> Option(voice)).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def setStickerSetThumb(name: String, userId: Int, thumb: Option[IFile] = Option.empty): Method[Boolean] = {
    ...
    MethodReq[Boolean]("setStickerSetThumb",
                       req.asJson,
                       Map("thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendVideo(chatId: ChatId,
    ...
    MethodReq[Message]("sendVideo",
                       req.asJson,
                       Map("video" -> Option(video), "thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendAnimation(chatId: ChatId,
    ...
    MethodReq[Message]("sendAnimation",
                       req.asJson,
                       Map("animation" -> Option(animation), "thumb" -> thumb).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def sendSticker(chatId: ChatId,
    ...
    MethodReq[Message]("sendSticker",
                       req.asJson,
                       Map("sticker" -> Option(sticker)).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
  ...
  def setWebhook(url: String,
    ...
    MethodReq[Boolean]("setWebhook",
                       req.asJson,
                       Map("certificate" -> certificate).collect { case (k, Some(v)) =>
                         k -> v
                       }
    )
  }
