...
/** Describes reply parameters for the message that is being sent.
  ...
  *   the channel (in the format &#064;channelusername)
  * @param allowSendingWithoutReply
  *   Optional. Pass True if the message should be sent even if the specified message to be replied to is not found; can
  *   be used only for replies in the same chat and forum topic.
  * @param quote
