...
object uPickleImplicits {
  ...
  implicit lazy val handleupdatereqCodec: ReadWriter[HandleUpdateReq] = {
    val updateIdKey           = upack.Str("updateId")
    val messageKey            = upack.Str("message")
    val editedMessageKey      = upack.Str("editedMessage")
    val channelPostKey        = upack.Str("channelPost")
  ...
  implicit lazy val handleupdateresCodec: ReadWriter[HandleUpdateRes] = {
    ...
    readwriter[upack.Msg].bimap(
      ...
      msg => {
        val m = msg.obj
        val result = for {
          result <- m.get(resultKey).map(x => readBinary[String](x))
        } yield {
          HandleUpdateRes(
            result = result
          )
...
object CirceImplicits {
  ...
  implicit lazy val inlinequeryresultcachedvoiceDecoder: Decoder[InlineQueryResultCachedVoice] =
    Decoder.instance { h =>
      for {
        ...
        InlineQueryResultCachedVoice(id = _id,
  ...
  implicit lazy val inlinequeryresultcachedmpeg4gifDecoder
    ...
    Decoder.instance { h =>
      for {
        ...
        InlineQueryResultCachedMpeg4Gif(id = _id,
  ...
  implicit lazy val inlinequeryresultcachedaudioDecoder: Decoder[InlineQueryResultCachedAudio] =
    Decoder.instance { h =>
      for {
        ...
        InlineQueryResultCachedAudio(id = _id,
  ...
  implicit lazy val inlinequeryresultcachedgifDecoder: Decoder[InlineQueryResultCachedGif] =
    Decoder.instance { h =>
      for {
        ...
        InlineQueryResultCachedGif(id = _id,
  ...
  implicit lazy val inputvenuemessagecontentDecoder: Decoder[InputVenueMessageContent] =
    Decoder.instance { h =>
      for {
        ...
        InputVenueMessageContent(latitude = _latitude,
                                 longitude = _longitude,
                                 title = _title,
                                 address = _address,
                                 foursquareId = _foursquareId,
  ...
  implicit lazy val inputlocationmessagecontentDecoder: Decoder[InputLocationMessageContent] =
    Decoder.instance { h =>
      for {
        ...
        InputLocationMessageContent(latitude = _latitude,
                                    longitude = _longitude,
                                    livePeriod = _livePeriod)
      }
    }
  ...
  implicit lazy val locationDecoder: Decoder[Location] =
    Decoder.instance { h =>
      for {
        ...
        Location(longitude = _longitude, latitude = _latitude)
      }
    }
  ...
  implicit lazy val passportfileDecoder: Decoder[PassportFile] =
    Decoder.instance { h =>
      for {
        ...
        PassportFile(fileId = _fileId, fileSize = _fileSize, fileDate = _fileDate)
      }
    }
  ...
  implicit lazy val photosizeDecoder: Decoder[PhotoSize] =
    Decoder.instance { h =>
      for {
        ...
        PhotoSize(fileId = _fileId, width = _width, height = _height, fileSize = _fileSize)
      }
    }
  ...
  implicit lazy val pollDecoder: Decoder[Poll] =
    Decoder.instance { h =>
      for {
        ...
        Poll(id = _id, question = _question, options = _options, isClosed = _isClosed)
      }
    }
  ...
  implicit lazy val fileDecoder: Decoder[File] =
    Decoder.instance { h =>
      for {
        ...
        File(fileId = _fileId, fileSize = _fileSize, filePath = _filePath)
      }
    }
  ...
  implicit lazy val chatphotoDecoder: Decoder[ChatPhoto] =
    Decoder.instance { h =>
      for {
        ...
        ChatPhoto(smallFileId = _smallFileId, bigFileId = _bigFileId)
      }
    }
  ...
  implicit lazy val voiceDecoder: Decoder[Voice] =
    Decoder.instance { h =>
      for {
        ...
        Voice(fileId = _fileId, duration = _duration, mimeType = _mimeType, fileSize = _fileSize)
      }
    }
  ...
  implicit lazy val messageentityDecoder: Decoder[MessageEntity] =
    Decoder.instance { h =>
      for {
        ...
        MessageEntity(`type` = _type, offset = _offset, length = _length, url = _url, user = _user)
      }
    }
  ...
  implicit lazy val handleupdatereqEncoder: Encoder[HandleUpdateReq] =
    (x: HandleUpdateReq) => {
      Json.fromFields(
        List(
          "update_id"            -> x.updateId.asJson,
  ...
  implicit lazy val handleupdatereqDecoder: Decoder[HandleUpdateReq] =
    Decoder.instance { h =>
      for {
        _updateId           <- h.get[Int]("update_id")
        _message            <- h.get[Option[Message]]("message")
  ...
  implicit lazy val handleupdateresEncoder: Encoder[HandleUpdateRes] =
    (x: HandleUpdateRes) => {
      Json.fromFields(
        List(
  ...
  implicit lazy val handleupdateresDecoder: Decoder[HandleUpdateRes] =
    Decoder.instance { h =>
      for {
        _result <- h.get[String]("result")
      } yield {
        HandleUpdateRes(result = _result)
      }
    }
