...
final case class InputMediaAnimation(media: String,
...
/** Represents a photo to be sent.
  ...
  * @param captionEntities Optional. List of special entities that appear in the
  * caption, which can be specified instead of parse_mode */
final case class InputMediaPhoto(media: String,
                                 caption: Option[String] = Option.empty,
                                 parseMode: Option[ParseMode] = Option.empty,
                                 captionEntities: List[MessageEntity] = List.empty)
    extends InputMedia
...
/** Represents a video to be sent.
  ...
  * @param supportsStreaming Optional. Pass True, if the uploaded video is suitable for
  * streaming */
final case class InputMediaVideo(media: String,
                                 thumb: Option[IFile] = Option.empty,
                                 caption: Option[String] = Option.empty,
                                 parseMode: Option[ParseMode] = Option.empty,
                                 captionEntities: List[MessageEntity] = List.empty,
...
final case class InputMediaDocument(media: String,
                                    thumb: Option[IFile] = Option.empty,
                                    caption: Option[String] = Option.empty,
                                    parseMode: Option[ParseMode] = Option.empty,
                                    captionEntities: List[MessageEntity] = List.empty,
...
final case class InputMediaAudio(media: String,
                                 thumb: Option[IFile] = Option.empty,
                                 caption: Option[String] = Option.empty,
                                 parseMode: Option[ParseMode] = Option.empty,
                                 captionEntities: List[MessageEntity] = List.empty,
